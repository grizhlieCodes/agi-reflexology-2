...
export const backgroundOptions: Type.BackgroundOptions = {
	...
	'primary-50': 'bg-primary-50 dark:bg-primary-950',
	'primary-100': 'bg-primary-100 dark:bg-primary-900',
	'primary-200': 'bg-primary-200 dark:bg-primary-800',
	'primary-300': 'bg-primary-300 dark:bg-primary-700',
	'primary-400': 'bg-primary-400 dark:bg-primary-600',
	'primary-500': 'bg-primary-500 dark:bg-primary-500',
	'primary-600': 'bg-primary-600 dark:bg-primary-400',
	'primary-700': 'bg-primary-700 dark:bg-primary-300',
	'primary-800': 'bg-primary-800 dark:bg-primary-200',
	'primary-900': 'bg-primary-900 dark:bg-primary-100',
	'primary-950': 'bg-primary-950 dark:bg-primary-50'
};
