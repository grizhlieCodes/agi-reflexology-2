	...
	<Container class="">
		<div class="flex w-full flex-col items-center gap-5">
			<div>
				...
				<Text type="h2" style="h6" id="homepage-my-services_heading"
					>What Kind of Support Do You Need?</Text
				>
			</div>
			<Text type="p" style="paraBase"
				>Choose the kind of support your body’s asking for—each session is tailored to how you feel
				that day.</Text
			>
		</div>

		<div class="flex flex-wrap justify-center gap-4 md:gap-8 xl:flex-nowrap">
