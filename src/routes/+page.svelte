<script lang="ts">
	...
	const priceCards: PriceCardTypes.PriceCard[] = [
		{
			cost: 65,
			...
			badges: {
				location: [{ type: 'default', Icon: MapPinHouse, content: "Agi\'s Studio" }],
				time: [{ type: 'primary', Icon: AlarmClock, content: '60min' }],
				key_info: [
					{
						type: 'primary',
						content: 'Face',
